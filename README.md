...
回归之前的问题，这里简单做下总结：
1.卡片的距离计算公式似乎不用太精确，以前以为mcx的前瞻因该很远，故需判断卡片的距离，但目前我们的mcx的前瞻跳的较低，相当于是画面中只要有卡片，就已经不远了，所以这里简单的用像素点之间的距离来代表两者之间的距离，效果也是可以的，所以啊空想不如实际去动手试一下
2.仓舵机的问题之前一直萦绕了我们很久，也换过舵机，买过新舵机，仍然不行，原来是**杜邦线接口松动**的问题，只能说"踏破铁鞋无觅处，得来全不费工夫"，现在仓转的很标准，回想之前的转角，一会就差个5度10度，不然就疯狂抖动，现在心情舒畅了
